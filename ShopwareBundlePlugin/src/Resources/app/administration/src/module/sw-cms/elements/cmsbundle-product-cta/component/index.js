import template from "./sw-cms-el-cmsbundle-product-cta.html.twig";
import "./sw-cms-el-cmsbundle-product-cta.scss";

const { Component, Mixin, Filter } = Shopware;

Component.register("sw-cms-el-cmsbundle-product-cta", {
  template,
  ...
  methods: {
    createdComponent() {
      this.initElementConfig("cmsbundle-product-cta");
      this.initElementData("cmsbundle-product-cta");
    },
  },
});
