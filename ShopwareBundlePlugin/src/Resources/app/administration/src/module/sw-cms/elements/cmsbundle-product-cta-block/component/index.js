import template from "./sw-cms-el-cmsbundle-product-cta-block.html.twig";
import "./sw-cms-el-cmsbundle-product-cta-block.scss";

const { Component, Mixin, Filter } = Shopware;

Component.register("sw-cms-el-cmsbundle-product-cta-block", {
  template,
  ...
  methods: {
    createdComponent() {
      this.initElementConfig("cmsbundle-product-cta-block");
      this.initElementData("cmsbundle-product-cta-block");
    },
  },
});
