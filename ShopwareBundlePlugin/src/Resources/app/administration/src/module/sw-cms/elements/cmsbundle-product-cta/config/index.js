import template from "./sw-cms-el-config-cmsbundle-product-cta.html.twig";
import "./sw-cms-el-config-cmsbundle-product-cta.scss";

const { Component, Mixin } = Shopware;

Component.register("sw-cms-el-config-cmsbundle-product-cta", {
  template,
